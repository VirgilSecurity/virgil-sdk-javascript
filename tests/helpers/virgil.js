...
assert(process.env.VIRGIL_PUBLIC_KEYS_URL, 'env.VIRGIL_PUBLIC_KEYS_URL is required');
assert(process.env.VIRGIL_PRIVATE_KEYS_URL, 'env.VIRGIL_PRIVATE_KEYS_URL is required');
...
module.exports = new Virgil(
	process.env.VIRGIL_APP_TOKEN,
	{
		...
		publicKeysBaseUrl: process.env.VIRGIL_PUBLIC_KEYS_URL,
		privateKeysBaseUrl: process.env.VIRGIL_PRIVATE_KEYS_URL
	}
);
